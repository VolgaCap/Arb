...
/**
 * sets field value to 32-bit integer
 * @param[in] ui   - library instance
 * @param[in] id   - node id. if 0 current node id is used
 * @param[in] name - field name
 * @param[in] value - field value
 * @return XROAD_OK if success, XROAD_FAILED otherwise
 */
xroad_errno_t ui_set_int32(ui_t* ui, xroad_node_id_t id, xroad_str_t name, int32_t value);
...
/**
 * sets field value to 64-bit integer
 * @param[in] ui   - library instance
 * @param[in] id   - node id. if 0 current node id is used
 * @param[in] name - field name
 * @param[in] value - field value
 * @return XROAD_OK if success, XROAD_FAILED otherwise
 */
xroad_errno_t ui_set_int64(ui_t* ui, xroad_node_id_t id, xroad_str_t name, int64_t value);
 ...
 * @return XROAD_OK if success, XROAD_FAILED otherwise
 */
xroad_errno_t ui_set_double(ui_t* ui, xroad_node_id_t id, xroad_str_t name, double value);
 ...
 * @return XROAD_OK if success, XROAD_FAILED otherwise
 */
xroad_errno_t ui_set_str(ui_t* ui, xroad_node_id_t id, xroad_str_t name, xroad_str_t value);
